...
if TYPE_CHECKING:
    ...
    from jenova.llm import LLMInterface
...
{{
    ...
    def _classify_intent(
        ...
        if query.startswith("/") or any(
            query_lower.startswith(cmd) for cmd in command_patterns
        ):
            return QueryIntent.COMMAND, 0.8
        
        ##Condition purpose: Check for question patterns
        question_words = ["what", "who", "where", "when", "why", "how", "which", "is", "are", "can", "do", "does"]
    ...
    def _assess_complexity(self, query: str) -> tuple[QueryComplexity, float]:
        ...
        complexity_indicators = [
            ...
            "therefore", "furthermore", "additionally", "moreover",
        ]
        indicator_count = sum(
    ...
    def _classify_type(self, query_lower: str) -> tuple[QueryType, float]:
        ...
        analytical_patterns = ["analyze", "compare", "evaluate", "difference", "pros and cons", "versus"]
    ...
    def _extract_keywords(self, query: str) -> list[str]:
        ...
        stop_words = {
            ...
            "we", "our", "ours", "you", "your", "he", "him", "his",
            "she", "her", "it", "its", "they", "them", "their", "what",
            "which", "who", "whom", "this", "that", "these", "those",
            "am", "and", "but", "if", "or", "because", "about",
        }
    ...
    def _extract_topics(self, query: str, query_lower: str) -> list[TopicResult]:
        ...
        tech_keywords = ["code", "programming", "software", "algorithm", "api", "database", "system", "python", "javascript"]
        ...
        temporal_keywords = ["when", "today", "yesterday", "tomorrow", "last", "next", "time", "schedule"]
