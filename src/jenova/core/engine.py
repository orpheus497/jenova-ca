...
from jenova.exceptions import LLMError, JenovaMemoryError, LLMParseError
...
Respond thoughtfully to the user's message, using the provided context and following the plan when relevant."""
    ...
    def _assess_complexity(self, user_input: str) -> PlanComplexity:
        ...
        complexity_indicators = [
            ...
            "step by step", "how does", "why does", "what are the",
            ...
            try:
                ...
                if json_match:
                    try:
                        ...
                        raise LLMParseError(plan_json, f"Invalid JSON: {e}")
                else:
                    raise LLMParseError(plan_json, f"Invalid JSON: {e}")
