...
class Cortex:
    ...
    def _load_grammar(self):
        ...
        self.ui_logger.system_message(f"⚠️  JSON grammar file not found at {grammar_path}")
        self.file_logger.log_warning(f"JSON grammar file not found at {grammar_path}")
        return None
