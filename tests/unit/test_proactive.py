...
def test_engine_initialization(default_config: ProactiveConfig, mock_graph: Mock, mock_llm: Mock) -> None:
...
def test_generate_suggestion_routes_to_correct_generator(engine: ProactiveEngine, mock_graph: Mock) -> None:
